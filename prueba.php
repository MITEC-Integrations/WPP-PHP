<?php
   ...
   $sdk = new MIT\SdkClient\WppClient('https://sandboxpo.mit.com.mx/gen', 'SNDBX123', '5DCC67393750523CD165F17E1EFADD21');
   $urlData = new MIT\SdkClient\Models\UrlData();
   ...
   $businessData = new MIT\SdkClient\Models\BusinessData();
   ...
   $paymentData = new MIT\SdkClient\Models\PaymentData();
   $paymentData->setUrl($urlData);
   $paymentData->setBusiness($businessData);

   $datosAd = new MIT\SdkClient\Models\DatosAdicionalesData();
   $dataAlgo = [];
   $dataItem = new MIT\SdkClient\Models\DataItem();
